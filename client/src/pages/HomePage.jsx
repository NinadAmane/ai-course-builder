...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 relative overflow-hidden transition-colors">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-slate-100 via-purple-200/10 to-slate-100 transition-colors pointer-events-none"></div>
          ...
          <div className="w-full max-w-6xl text-center space-y-12">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold leading-tight">
                  <span className="block mb-2">Build Courses with</span>
            ...
            <div className="max-w-3xl mx-auto">
              <div className="relative">
                ...
                <div className="relative bg-white/70 text-slate-900 backdrop-blur-xl border border-black/10 rounded-3xl p-8 shadow-2xl transition-colors">
                      ...
                      <div className="space-y-10">
                        {course.modules.map((module, index) => (
                          <div key={index} className="relative group">
                            ...
                            <div className="relative bg-white/70 text-slate-900 backdrop-blur-sm border border-black/10 rounded-2xl p-6 hover:border-black/20 transition-all duration-300">
                              <div className="text-left mb-6">
                                ...
                                {/* AI Summary Panel */}
                                {module.summary && (
                                  <div className="mt-4 ml-11 p-4 bg-black/5 border border-black/10 rounded-xl">
                                  ...
                                  {module.videos.map((video) => (
                                    ...
                                    >
                                      <div className="relative aspect-video overflow-hidden bg-slate-200">
                                        ...
                                        />
                                        <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 group-hover/video:opacity-100 transition-opacity duration-300"></div>
